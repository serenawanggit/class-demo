...
<link href="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/style/cssv2/self.css?v=3.2.0" rel="stylesheet">

<div class="mine_head" style="background-image:url(http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/agency-top.jpg?v=2);">
		<a class="aui-member-setting" href="./index.php?i=10&amp;c=mc&amp;a=profile&amp;">
		<img src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-setting.png?v=2">
	</a>
		<div class="mine_head_body">
		<div class="tx">
			<img src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/default_avatar.jpg" id="btn-avatar" alt="会员头像">
		</div>
		<div class="nickname">未设置</div>
		<div class="idno">乐宝学号：2252</div>
	</div>
</div>


<div class="mine_unit ios-system">
	<a href="./index.php?i=10&amp;c=entry&amp;do=mylesson&amp;m=fy_lessonv2" class="line-grid icon_right flex1" style="border-bottom: 1px solid #e4e5ea;">
		<div class="boldtext flex-al1">全部订单</div>
		<div class="more">查看全部订单</div>
	</a>
</div>
<div class="mine_menu_grid li4 ios-system">
	<a href="./index.php?i=10&amp;c=entry&amp;status=nopay&amp;do=mylesson&amp;m=fy_lessonv2" class="mine_menu">
		<div class="img">
			<img src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-nopay.png">
		</div>
		<div>待付款</div>
	</a>
	<a href="./index.php?i=10&amp;c=entry&amp;status=payed&amp;do=mylesson&amp;m=fy_lessonv2" class="mine_menu">
		<div class="img">
			<img src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-pay.png">
		</div>
		<div>已付款</div>
	</a>
		<a href="./index.php?i=10&amp;c=entry&amp;status=allow_verify&amp;do=mylesson&amp;m=fy_lessonv2" class="mine_menu">
			<div class="img">
			<img src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-noverify.png">
		</div>
		<div>可核销</div>
	</a>
	<a href="./index.php?i=10&amp;c=entry&amp;status=no_evaluate&amp;do=mylesson&amp;m=fy_lessonv2" class="mine_menu">
		<div class="img">
			<img src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-evaluate.png">
		</div>
		<div>待评价</div>
	</a>
</div>
...
<div class="mine_unit">
	<a class="line-grid flex1" href="javascript:;" id="subscribe-btn">
		<div class="img flex0">
			<img class="flex_g0" src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-subscribe.png?v=8" style="width: 16px;">
		</div>
		<div class="flex-al1">订阅消息</div>
		<i class="fa fa-toggle-on" id="subscribe-status" data-subscribe="1"></i>
	</a>
		<a href="./index.php?i=10&amp;c=entry&amp;do=vip&amp;m=fy_lessonv2" class="line-grid icon_right flex1">
		<div class="img flex0">
			<img class="flex_g0" src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-vip-service.png?v=8" style="width: 16px;">
		</div>
		<div class="flex-al1">VIP服务</div>
	</a>
			<a href="./index.php?i=10&amp;c=entry&amp;do=myteacher&amp;m=fy_lessonv2" class="line-grid icon_right flex1 ios-system">
		<div class="img flex0">
			<img class="flex_g0" src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-teacher-buy.png?v=8" style="width: 16px;">
		</div>
		<div class="flex-al1">讲师服务</div>
	</a>
			<a href="./index.php?i=10&amp;c=entry&amp;do=reclesson&amp;m=fy_lessonv2" class="line-grid icon_right flex1 ios-system">
		<div class="img flex0">
			<img class="flex_g0" src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-lesson-invite.png?v=8" style="width: 16px;">
		</div>
		<div class="flex-al1">课程邀请</div>
	</a>
			<a href="./index.php?i=10&amp;c=entry&amp;do=history&amp;m=fy_lessonv2" class="line-grid icon_right flex1">
		<div class="img flex0">
			<img class="flex_g0" src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-history.png?v=6" style="width: 16px;">
		</div>
		<div class="flex-al1">我的足迹</div>
	</a>
			<a href="./index.php?i=10&amp;c=entry&amp;ctype=1&amp;do=collect&amp;m=fy_lessonv2" class="line-grid icon_right flex1">
		<div class="img flex0">
			<img class="flex_g0" src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-collect-lesson.png?v=6" style="width: 16px;">
		</div>
		<div class="flex-al1">收藏课程</div>
	</a>
			<a href="./index.php?i=10&amp;c=entry&amp;ctype=2&amp;do=collect&amp;m=fy_lessonv2" class="line-grid icon_right flex1">
		<div class="img flex0">
			<img class="flex_g0" src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-collect-teacher.png?v=8" style="width: 16px;">
		</div>
...
<div class="mine_unit">
		<a href="./index.php?i=10&amp;c=entry&amp;do=teachercenter&amp;m=fy_lessonv2" class="line-grid icon_right flex1 ios-system">
		<div class="img flex0">
			<img class="flex_g0" src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-collect-teachercenter.png?v=8" style="width: 16px;">
		</div>
		<div class="flex-al1">讲师中心</div>
	</a>
			<a href="./index.php?i=10&amp;c=entry&amp;do=commission&amp;m=fy_lessonv2" class="line-grid icon_right flex1 ios-system">
		<div class="img flex0">
			<img class="flex_g0" src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-commission.png?v=6" style="width: 16px;">
		</div>
		<div class="flex-al1">分销中心</div>
	</a>
			<a href="./index.php?i=10&amp;c=entry&amp;do=studyduration&amp;m=fy_lessonv2" class="line-grid icon_right flex1">
		<div class="img flex0">
			<img class="flex_g0" src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-study-duration.png?v=8" style="width: 16px;">
		</div>
		<div class="flex-al1">学习时长</div>
	</a>
			<a href="./index.php?i=10&amp;c=entry&amp;do=coupon&amp;m=fy_lessonv2" class="line-grid icon_right flex1 ios-system">
		<div class="img flex0">
			<img class="flex_g0" src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-coupon.png?v=6" style="width: 16px;">
		</div>
...
<div class="mine_unit">
		<a href="./index.php?i=10&amp;c=entry&amp;op=modifyMobile&amp;do=writemsg&amp;m=fy_lessonv2" class="line-grid icon_right flex1">
		<div class="img flex0">
			<img class="flex_g0" src="http://xianke88.cn/addons/fy_lessonv2/template/mobile/default/images/self-icon-modify-mobile.png?v=8" style="width: 16px;">
		</div>
...
<div class="logout">
	<a href="./index.php?i=10&amp;c=mc&amp;a=home&amp;do=login_out&amp;">退出登录</a>
</div>
	...
	<footer></footer>
		...
		<div id="footer-nav" class="footer-nav">
			...
			<a
				...
				href="${pageContext.request.contextPath }/page/myself.jsp" class="weui-tabbar__item weui-bar__item_on"> 
				<img src="${pageContext.request.contextPath }/image/attachment/images/10/2019/04/img-mySelf.png" class="weui-tabbar__icon" />
